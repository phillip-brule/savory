    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-brown/10 bg-cream/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          <a
            href={`https://wa.me/${site.whatsapp}?text=${encodeURIComponent('¡Hola! Me gustaría cotizar con Savory.')}`}
            target="_blank"
            rel="noopener noreferrer"
            className="hidden rounded-full bg-green px-4 py-2 text-sm font-bold text-cream transition hover:bg-green-light sm:inline-flex"
          >
            Cotizar
          </a>
        ...
        <nav className="border-t border-brown/10 bg-cream px-4 py-4 md:hidden">
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-2 rounded-full bg-green px-4 py-2 text-center text-sm font-bold text-cream"
            >
